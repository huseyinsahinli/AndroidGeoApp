package com.hsynshnl.geometriccalculation.Parallelogram
...
import kotlinx.android.synthetic.main.activity_main_rectangle.text_view_number_b
...
class MainParallelogramActivity : AppCompatActivity() {
    lateinit var mAdView: AdView
    override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main_parallelogram)
